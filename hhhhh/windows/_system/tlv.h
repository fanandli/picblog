...
struct _tlv {
  unsigned char type;
  unsigned char res;
  unsigned short len; //16Î»³¤¶È£¬Òª¿¼ÂÇ´óÐ¡Ðò£¬±ØÐë×ª³ÉÍøÂçÐò
};
...
public:
  enum MSGTYPE { //msg must be pair of requst and reply which with correct odd/even 
    ...
    RQUERYSVCADDR = 0x87, //
    INNERSHELLMSG = 0x88,
    COOKIECONFIRM = 0x89, //·ÏÆú
    RCOOKIECONFIRM = 0x8a, //·ÏÆú
    LOGIN, //login
    RLOGIN, //login reply
...
//    LOGIN_NAME = 2, // if pwdis mac-address
 //   LOGIN_PWD = 4, 
  ...
  enum GETSVCPUBLICADDR_SUBTYPE {
    //GETSVCPUBLICADDR_TLP = 1,
    GETSVCPUBLICADDR_INTRAPORT = 2,
    GETSVCPUBLICADDR_TYPE = 4,
    GETSVCPUBLICADDR_IP = 6,
    GETSVCPUBLICADDR_PORT = 8,
    GETSVCPUBLICADDR_TOKEN = 10,
  };
  ...
  enum RGETSVCPUBLICADDR_SUBTYPE {
    //synheader
    //RGETSVCPUBLICADDR_TLP = 1,
    //RGETSVCPUBLICADDR_INTRAPORT = 2,
    RGETSVCPUBLICADDR_RESULT = 1,
    RGETSVCPUBLICADDR_IP = 4,
    RGETSVCPUBLICADDR_PORT = 6,
  };
  ...
  enum INNERLOGIN_SUBTYPE {
    INNERLOGIN_CLTMAC = 0,
    INNERLOGIN_USER = 2, //·ÏÆú
    INNERLOGIN_PWD = 4, // ·ÏÆú
  };
...
//#ifdef _NODRIVER_
  enum DRV_RMTACCEPT_SUBTYPE {
    DRV_RMTACCECPT_RELAYPORT = 0,
    DRV_RMTACCECPT_CLTADDR = 2, //client service port
    DRV_RMTACCECPT_RELAYFWDID = 4,
    DRV_RMTACCECPT_SNDBUFLEN = 5, //service tcp send buf
    DRV_RMTACCECPT_TCPXPORT = 6,
  };

  enum DRV_RRMTACCEPT_SUBTYPE {
    DRV_RRMTACCECPT_RELAYPORT = 0,
    DRV_RRMTACCECPT_RELAYFWDID = 2,
    //DRV_RRMTACCECPT_CLTFWDID = 4, //client service socket
  };
//#endif

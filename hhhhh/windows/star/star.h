...
class ShellUdpSock :public SockExUDP { //处理udp类型的socket
public:
  ...
  static int proInnerSerialize(SockEx*, StarTlv& tlvs);//对tlv进行序列化
};

struct StarAttr {//路由器的属性
  //UINT32 bestIP;
  //STAGE stage;
  //Timer tm;
  NBS_NETTYPE netType;
